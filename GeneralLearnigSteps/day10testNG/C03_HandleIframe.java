...
public class C03_HandleIframe {
    // Iframe nedir: bir sitenin icinde gomulu baska bir site
    //              mesela cogu sitede youtube gomuludur
    // locate etsek bile selenium iframe i direkt goremez
    // switchTo() methoduyla iframe gecmenin 3 yolu var
    // 1- index ile 2- id veya name value ile 3- webelementi ile
    //iframe den cikmak icinde (alertte her isim oldugunda git yap zaten kendi doner)
    //cunku iframe giderse orda kalir . 2 yolu var parentFrame,defaultFrame
